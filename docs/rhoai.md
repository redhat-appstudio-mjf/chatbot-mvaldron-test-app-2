...
2) Go to the `Data Science Projects` section and access your application's project named `rolling-demo-ns-app-development`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `chatbot-mvaldron-test-app-2-notebook`.
...
5) In the terminal, run `cd chatbot-mvaldron-test-app-2` to navigate to your sample app's directory.
